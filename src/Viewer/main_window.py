...
class Ui_MainWindow(object):
    def setupUi(self, MainWindow):
        ...
        self.pushButton_export.setGeometry(QtCore.QRect(40, 180, 181, 31))
        font = QtGui.QFont()
        font.setFamily("宋体")
        ...
        self.lineEdit_key.setGeometry(QtCore.QRect(90, 50, 321, 31))
        ...
        self.pushButton_browse.setGeometry(QtCore.QRect(330, 120, 81, 31))
        self.pushButton_browse.setObjectName("pushButton_browse")
        self.lineEdit_dir = QtWidgets.QLineEdit(self.centralwidget)
        self.lineEdit_dir.setGeometry(QtCore.QRect(90, 120, 231, 31))
        ...
        self.pushButton_import.setGeometry(QtCore.QRect(230, 180, 181, 31))
        font = QtGui.QFont()
        font.setFamily("宋体")
        font.setPointSize(14)
